...
const buttons = { pan: modePan, coord: modeCoord, dist: modeDist, select: modeSelect, line: modeLine, poly: modePoly, circle: modeCircle, text: modeText, offset: modeOffset };
...
let offsetState = null; // v62: OFFSET command state（対象選択→距離入力→方向指定→再クリック確定）
...
modeLine.onclick=()=>setMode('line'); modePoly.onclick=()=>setMode('poly'); modeCircle.onclick=()=>setMode('circle'); modeText.onclick=()=>setMode('text'); if(typeof modeOffset !== 'undefined') modeOffset.onclick=()=>setMode('offset');
...
function cancelDrawing(){
  hideCircleChoicePanel();
  drawState=null; lineReleaseState=null; polyReleaseState=null; circleReleaseState=null; measureStart=null; measureEnd=null; moveState=null; copyState=null; offsetState=null; hideObjectMenu();
